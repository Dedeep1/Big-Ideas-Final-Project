...
```
```
Henry Ndoka Hen34@pitt.edu
Analyized one dataset, information on all the parks of Pittsburgh
Metric: Density/# of parks within every neighborhood of pittsburgh
Dataset link: https://data.wprdc.org/datastore/dump/fa329e3d-89ff-4708-8ddf-81bfedcad11d
```
